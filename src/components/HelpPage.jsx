...
const HelpPage = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer: 'Вы можете связаться с нашей службой поддержки по телефонам: +998612221246 или +998999567796. Также вы можете написать нам на электронную почту info@market-kkm.uz.',
    },
    {
